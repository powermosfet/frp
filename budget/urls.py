...
urlpatterns = patterns('',
    ...
    url(r'^accounting/$',                              login_required(AccountingDefaultView),                     name='accounting_main'),
    url(r'^accounting/(?P<year>\d+)/(?P<month>\d+)/$', login_required(AccountingView.as_view(month_format='%m')), name='accounting'),
