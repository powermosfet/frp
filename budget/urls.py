...
urlpatterns = patterns('',
    ...
    url(r'^accounting/$',                              login_required(AccountingView.as_view()),                            name='accounting_main'),
    ...
    url(r'^accounting/transaction/(?P<year>\d+)/(?P<month>\d+)/$',      login_required(TransactionArchive.as_view(month_format='%m')),               name='transaction_update'),
